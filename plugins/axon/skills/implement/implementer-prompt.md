...
- **Before writing any code**: Read the project-root `.axon/interface-registry.md`. Register every public export you plan to create (function signatures, class APIs, type exports) in the registry. Write the registry entries FIRST, then implement to match them.
...
- Create a public export that isn't registered in the project-root `.axon/interface-registry.md`
