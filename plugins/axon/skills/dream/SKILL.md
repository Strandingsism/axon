...
Save to the project-root `.axon/specs/YYYY-MM-DD-<topic>-design.md`:
...
> I've written the design at the project-root `.axon/specs/2026-06-06-<topic>-design.md`. Please review. Once approved, I'll invoke `write-plan`.

Do NOT invoke `write-plan` until the user confirms.

### 8. Update Project Map

Initialize the project-root `.axon/project-map.md`: set the Goal, mark phase 1 done.
